...
function createInvalidObservableTypeError(input2) {
  return new TypeError(
    "You provided " +
      (input2 !== null && typeof input2 === "object" ? "an invalid object" : "'" + input2 + "'") +
...
function runInInjectorProfilerContext(injector, token, callback) {
  !ngDevMode &&
    throwError2("runInInjectorProfilerContext should never be called in production mode");
...
function isDirectiveDefHack(obj) {
  return (
    obj.type !== void 0 && obj.declaredInputs !== void 0 && obj.findHostDirectiveDefs !== void 0
  );
}
...
function isDisconnectedNode(tNode, lView) {
  return (
    !(tNode.type & 16) && !!lView[tNode.index] && !unwrapRNode(lView[tNode.index])?.isConnected
  );
}
...
var ContentChild = makePropDecorator(
  "ContentChild",
  (selector, opts = {}) =>
    __spreadValues({ selector, first: true, isViewQuery: false, descendants: true }, opts),
  Query
);
...
var ViewChild = makePropDecorator(
  "ViewChild",
  (selector, opts) =>
    __spreadValues({ selector, first: true, isViewQuery: true, descendants: true }, opts),
  Query
);
...
function patchComponentDefWithScope(componentDef, transitiveScopes) {
  ...
  componentDef.pipeDefs = () =>
    Array.from(transitiveScopes.compilation.pipes).map(pipe2 => getPipeDef$1(pipe2));
...
var Component = makeDecorator(
  "Component",
  (c = {}) => __spreadValues({ changeDetection: ChangeDetectionStrategy.Default }, c),
  Directive,
  void 0,
      ...
      if (instance2 !== null) {
        if (formattedDependency.flags.host) {
          ...
          const lookupFromFirstInjector = firstInjector.get(
            dep.token,
            null,
            __spreadProps(__spreadValues({}, formattedDependency.flags), { optional: true })
          );
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JXWBXESQ.js.map
