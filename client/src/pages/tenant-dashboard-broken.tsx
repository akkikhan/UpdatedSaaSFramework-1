...
function StatsCard({ title, value, change, icon: Icon, color }: {
  ...
  return (
    <Card className="bg-white/80 backdrop-blur-sm border border-slate-200/50 shadow-sm hover:shadow-md transition-shadow">
...
function ModuleCard({ module, tenant, onToggle, onConfigure }: {
  module: any;
  tenant: any;
  ...
  return (
    <Card className={`bg-white/80 backdrop-blur-sm border transition-all duration-300 hover:shadow-lg ${
      isEnabled 
        ? 'border-green-300 shadow-green-100 bg-gradient-to-br from-green-50/50 to-white' 
...
function ProviderCard({ type, name, description, enabled, configured }: {
  type: string;
  name: string;
  description: string;
  enabled: boolean;
  ...
  return (
    <Card className={`bg-white/80 backdrop-blur-sm border transition-all duration-300 ${
      enabled && configured
        ? 'border-green-300 shadow-green-100 bg-gradient-to-br from-green-50/50 to-white'
        : 'border-slate-200/50 shadow-sm hover:shadow-md'
    }`}>
      <CardHeader>
        <div className="flex items-center justify-between">
...
function ApiKeyCard({ title, description, apiKey, icon: Icon, showKey }: {
  title: string;
  description: string;
  apiKey: string;
  icon: any;
  ...
  return (
    <Card className="bg-white/80 backdrop-blur-sm border border-slate-200/50 shadow-sm">
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-slate-600">{description}</p>
        <div className="flex items-center space-x-2">
          <code className="flex-1 bg-slate-100 px-3 py-2 rounded text-sm font-mono border">
