...
const MODULE_INFO = [
  {
    ...
    features: ["Basic JWT Auth", "Azure AD SSO", "Auth0 Integration", "SAML 2.0", "Multi-Factor Auth"]
  },
  {
    id: "rbac",
    ...
    features: ["Custom Roles", "Granular Permissions", "Industry Templates", "Compliance (SOX, HIPAA)"]
  },
  {
    id: "logging",
  ...
  },
  {
    ...
    description: "Performance monitoring, alerting, and system health tracking",
    icon: FileText,
    color: "bg-purple-500",
    recommended: true,
    required: false,
    ...
    features: ["Performance Metrics", "Health Checks", "Alert Rules", "Real-time Dashboards"]
  },
  {
    id: "notifications",
  ...
  },
  {
    ...
    description: "Risk analysis, fraud detection, compliance automation, and intelligent insights",
    icon: Bot,
    color: "bg-indigo-500",
    recommended: false,
    required: false,
