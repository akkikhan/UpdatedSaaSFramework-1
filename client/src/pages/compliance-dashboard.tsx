...
export default function ComplianceDashboard() {
  ...
  if (summaryLoading) {
    return (
      <div
        ...
        data-testid="loading-compliance"
      >
  ...
  return (
    <div className="aspire-page-container" data-testid="compliance-dashboard">
      {/* Aspire Page Header */}
        ...
        <div className="aspire-header-content">
          <div className="aspire-header-text">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="aspire-page-title" data-testid="title-compliance">
                  Compliance Dashboard
                </h1>
                <p className="aspire-page-subtitle">
                  Monitor audit logs, security events, and regulatory compliance
                </p>
              </div>
            </div>
          </div>
          <div className="aspire-header-actions">
        ...
        <div className="aspire-main-card">
          ...
          {summary && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <Card data-testid="card-rbac-changes">
                ...
                <CardContent>
                  <div className="text-2xl font-bold" data-testid="text-rbac-changes">
                    {summary.rbacChanges}
                  </div>
              ...
              <Card data-testid="card-security-events">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {summary.criticalSecurityEvents} critical
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <Tabs defaultValue="audit-logs" className="space-y-4">
            <TabsList data-testid="tabs-compliance">
              ...
              <TabsTrigger value="security-events" data-testid="tab-security-events">
                Security Events
              </TabsTrigger>
              <TabsTrigger value="risk-analysis" data-testid="tab-risk-analysis">
                Risk Analysis
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="audit-logs" className="space-y-4">
              <Card data-testid="card-audit-logs">
                ...
                <CardContent>
                  {auditLoading ? (
                    <div className="text-center py-4" data-testid="loading-audit-logs">
                      Loading audit logs...
                    </div>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <Badge
                                className={getRiskBadgeColor(log.riskLevel)}
                                data-testid={`badge-risk-${log.riskLevel}`}
                              >
                                {log.riskLevel.toUpperCase()}
                              </Badge>
                              <span className="font-semibold" data-testid={`text-action-${log.id}`}>
                                {log.action}
                              </span>
                            </div>
                          ...
                          <div className="text-sm">
                            <span className="text-gray-600">Entity:</span> {log.entityType} -{" "}
                            {log.entityName}
                          </div>
                          <div className="text-sm">
                          ...
                          <div className="flex gap-1 flex-wrap">
                            {log.complianceFrameworks.map(framework => (
                              <Badge
                                ...
                                variant="secondary"
                                className="text-xs"
                                data-testid={`badge-framework-${framework}`}
                              >
                                {framework.toUpperCase()}
                              </Badge>
                            ))}
            ...
            <TabsContent value="security-events" className="space-y-4">
              <Card data-testid="card-security-events-detail">
                ...
                <CardContent>
                  {securityLoading ? (
                    <div className="text-center py-4" data-testid="loading-security-events">
                      ...
                      {securityEvents.map(event => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <Badge
                                className={getSeverityBadgeColor(event.severity)}
                              ...
                              {event.isResolved && (
                                <Badge
                                  ...
                                  data-testid={`badge-resolved-${event.id}`}
                                >
                                  Resolved
                                </Badge>
                              )}
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-500">
                              <Clock className="h-4 w-4" />
                              <span data-testid={`text-event-timestamp-${event.id}`}>
                    ...
                    <div
                      ...
                      data-testid="empty-security-events"
                    >
                  ...
                  {summary && (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div
                        ...
                        data-testid="risk-critical"
                      >
                        <div
                          className="text-2xl font-bold text-red-600"
                          data-testid="text-risk-critical"
                        >
